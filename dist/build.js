...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuetify__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuetify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vuetify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_resource__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Forecast_vue__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Forecast_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Forecast_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Home_vue__ = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_router__ = __webpack_require__(95);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_5_vue_router__["a" /* default */]({
  routes: [{
    path: '/',
    name: 'Home',
    ...
    path: '/forecast',
    name: 'Forecast',
    component: __WEBPACK_IMPORTED_MODULE_3__components_Forecast_vue___default.a
  }]
}));
...
new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
  ...
  render: site => site(__WEBPACK_IMPORTED_MODULE_1__App_vue___default.a)
});
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      tableHeaders: [{ text: 'Time', value: 'time' }, { text: 'Description', value: 'description' }, { text: 'Humidity', value: 'humidity' }, { text: 'Pressure', value: 'pressure' }, { text: 'Temperature', value: 'temp' }, { text: 'Max / Min', value: 'maxmin' }]
    };
  },

  created: function created() {},
  methods: {
    getForecast: function getForecast(cityName) {
      var _this = this;

      return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var res, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, key;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this.$http.get('/api/forecast/' + cityName);

              case 3:
                res = _context.sent;

                //let res = await this.$http.get(`/src/assets/testdata.json`);
                _this.forecastResults = res.body;
                _this.dateObject = {};
                _iteratorNormalCompletion = true;
                _didIteratorError = false;
                _iteratorError = undefined;
                _context.prev = 9;
                for (_iterator = (0, _getIterator3.default)(res.body.list); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  item = _step.value;
                  key = moment(item.dt_txt).format('dddd');

                  if (!_this.dateObject.hasOwnProperty(key)) {
                    _this.dateObject[key] = [];
                  }
                  _this.dateObject[key].push(item);
                }
                _context.next = 17;
                break;
    ...
    convertTemperature: function convertTemperature() {
    ...
    convertDegrees: function convertDegrees(value) {
    ...
    convertToDay: function convertToDay(value, format) {
      ...
      return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log("Async works in Hello!");
...
var perform = __webpack_require__(31);
...
// module
exports.push([module.i, "p[data-v-2cdec1f8]{color:#ff8c00}.weather-container[data-v-2cdec1f8]{min-height:800px}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "container weather-container"
  }, [_c('v-card', {
  ...
  }, [_vm._v("Enter City Name")])], 1), _c('v-flex', {
    staticClass: "xs8"
  }, [_c('v-text-field', {
    staticClass: "input-group--focused",
    attrs: {
      "label": "Enter a city name (i.e. Edinburgh, London, Glasgow)",
      "dark": "dark",
  ...
  })], 1)], 1)], 1)], 1)], 1), (_vm.isReady) ? _c('div', [_c('p', {
    staticClass: "right"
  }, [_c('strong', [_vm._v("results found:   ")]), _vm._v(_vm._s(_vm.forecastResults.city.name))]), _vm._l((_vm.dateObject), function(value, key) {
    return _c('div', [_c('br'), _c('br'), _c('h4', [_vm._v(_vm._s(key)), _c('small', [_vm._v("    " + _vm._s(_vm.convertToDay(_vm.dateObject[key].dt_txt, "MMM Do YY")))])]), _c('v-data-table', {
      staticClass: "elevation-3",
      attrs: {
        "headers": _vm.tableHeaders,
        "items": _vm.dateObject[key],
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function(props) {
          ...
          }, [_vm._v(_vm._s(_vm.convertToDay(props.item.dt_txt, 'hh:mm')))]), _vm._l((props.item.weather), function(weather) {
            return _c('td', {
              staticClass: "text-xs-right"
            }, [_vm._v(_vm._s(weather.description))])
          }), _c('td', {
            staticClass: "text-xs-right"
          }, [_vm._v(_vm._s(props.item.main.humidity))]), _c('td', {
            staticClass: "text-xs-right"
          }, [_vm._v(_vm._s(props.item.main.pressure))]), _c('td', {
            staticClass: "text-xs-right"
          }, [_vm._v(_vm._s(_vm.convertDegrees(props.item.main.temp)) + _vm._s(_vm.degreeType))]), _c('td', {
            staticClass: "text-xs-right"
          }, [_vm._v(_vm._s(_vm.convertDegrees(props.item.main.temp_max)) + " / " + _vm._s(_vm.convertDegrees(props.item.main.temp_min)) + _vm._s(_vm.degreeType))])]
        }
      }])
    }), _c('br'), _c('br')], 1)
  })], 2) : _vm._e()], 1)
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('main', [_c('section', [_c('v-parallax', {
    attrs: {
    ...
    staticClass: "white--text mb-2 display-3"
  }, [_vm._v("Weather Demo")]), _c('div', {
    staticClass: "headline mb-3 text-xs-center"
  }, [_vm._v("Powered by Vue | Vuetify | ES6 | Webpack | Express4")]), _c('router-link', {
    attrs: {
      "to": "/forecast"
    }
  }, [_c('v-btn', {
    staticClass: "blue lighten-2 mt-5 dark large"
  }, [_vm._v("Forecast")])], 1)], 1)], 1)], 1)]), _c('section', [_c('v-layout', {
    staticClass: "my-5 column wrap align-center"
  }, [_c('v-flex', {
    staticClass: "my-3 xs12 sm4"
  }, [_c('div', {
    staticClass: "text-xs-center"
  }, [_c('h2', {
    staticClass: "headline"
  }, [_vm._v("Who doesn't love a good weather realted pun?")]), _c('span', {
    staticClass: "subheading"
  }, [_vm._v("The brightest day of the week is Sun-day!")])])]), _c('v-flex', {
    attrs: {
      "xs12": ""
    }
  }, [_c('v-container', {
  ...
  }, [_vm._v("color_lens")])], 1), _c('v-card-title', {
  ...
  }, [_vm._v("Vue & Vuetify")])]), _c('v-card-text', [_vm._v("Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.\nPellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.\nNullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.")])], 1)], 1), _c('v-flex', {
    attrs: {
      "xs12": "",
      "md4": ""
    }
  ...
  }, [_vm._v("flash_on")])], 1), _c('v-card-title', {
    staticClass: "layout justify-center",
    attrs: {
      "primary-title": ""
    }
    ...
    staticClass: "headline"
  }, [_vm._v("Express & Heroku")])]), _c('v-card-text', [_vm._v("Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.\nPellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.\nNullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.")])], 1)], 1), _c('v-flex', {
    attrs: {
      "xs12": "",
      "md4": ""
    }
  ...
  }, [_vm._v("build")])], 1), _c('v-card-title', {
    staticClass: "layout justify-center",
    attrs: {
      "primary-title": ""
    }
    ...
    staticClass: "headline text-xs-center"
  }, [_vm._v("ES6 & Webpack")])]), _c('v-card-text', [_vm._v("Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.\nPellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.\nNullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.")])], 1)], 1)], 1)], 1)], 1)], 1)], 1), _c('section', [_c('v-parallax', {
    attrs: {
      "src": "src/assets/road.jpg",
      "height": "380"
    }
  }, [_c('v-layout', {
    attrs: {
    ...
    staticClass: "headline white--text mb-3"
  }, [_vm._v("Weather checking is literally as simple as clicking this button")]), _c('router-link', {
    attrs: {
      "to": "/forecast"
    }
  }, [_c('v-btn', {
    staticClass: "blue lighten-2 mt-5 dark large"
  }, [_vm._v("Forecast")])], 1)], 1)], 1)], 1), _c('section', [_c('v-container', {
    attrs: {
      "grid-list-xl": ""
    }
  }, [_c('v-layout', {
    ...
    staticClass: "headline"
  }, [_vm._v("Company info")])]), _c('v-card-text', [_vm._v("Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.\nPellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.\nNullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.")])], 1)], 1), _c('v-flex', {
    attrs: {
      "xs12": "",
      "sm4": "",
      "offset-sm1": ""
    ...
    staticClass: "headline"
  }, [_vm._v("Contact us")])]), _c('v-card-text', [_vm._v("Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.")]), _c('v-list', {
    staticClass: "transparent"
  }, [_c('v-list-tile', [_c('v-list-tile-action', [_c('v-icon', {
    staticClass: "blue--text text--lighten-2"
  }, [_vm._v("phone")])], 1), _c('v-list-tile-content', [_c('v-list-tile-title', [_vm._v("555-555-5555")])], 1)], 1), _c('v-list-tile', [_c('v-list-tile-action', [_c('v-icon', {
    staticClass: "blue--text text--lighten-2"
  }, [_vm._v("place")])], 1), _c('v-list-tile-content', [_c('v-list-tile-title', [_vm._v("Edinburgh, UK")])], 1)], 1), _c('v-list-tile', [_c('v-list-tile-action', [_c('v-icon', {
    staticClass: "blue--text text--lighten-2"
  }, [_vm._v("email")])], 1), _c('v-list-tile-content', [_c('v-list-tile-title', [_vm._v("allen.royston.uk@gmail.com")])], 1)], 1)], 1)], 1)], 1)], 1)], 1)], 1)])
},staticRenderFns: []}
...
var update = __webpack_require__(43)("2d9f6f63", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(43)("0fa771c6", content, true);
